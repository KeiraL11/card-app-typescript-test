  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="m-3 p-4 text-x1 bg-gray-300 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-700 rounded-md front-medium text-black dark:text-white transition-colors duration-300"
      >
