...
const EditEntry: React.FC<EditEntryProps> = ({darkMode}) => {
    ...
    return(
        <section className={darkMode ? "flex justify-center flex-col w-fit ml-auto mr-auto mt-10 gap-5 bg-gray-900 p-8 rounded-md" : "flex justify-center flex-col w-fit ml-auto mr-auto mt-10 gap-5 bg-gray-300 p-8 rounded-md"}>
            ...
            <button type="button" onClick={handleToggleScheduleAt} className="px-4 py-2 bg-blue-400 text-white rounded hover:bg-blue-600">{showScheduledAt ? 'Hide Schedule At' : 'Add Schedule At'}</button>
